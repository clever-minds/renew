...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-5xl" x-data="{
        ...
        async submitClient() {
            ...
            this.errors = {};
            try {
                const response = await fetch('<?php echo e(route('app.clients.store')); ?>', {
                    method: 'POST',
                    headers: {
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 bg-gray-50/50 border-b border-gray-100 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('app.invoices.index')); ?>" class="text-xs font-bold text-gray-500 hover:text-gray-700 uppercase tracking-widest">
                    <i class="fas fa-arrow-left mr-1"></i> Back to List
                </a>
            </div>
            
            <div class="p-6">
                <form method="POST" action="<?php echo e(route('app.invoices.store')); ?>" class="space-y-8" id="invoice-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="issue_date" id="issue_date" required value="<?php echo e(date('Y-m-d')); ?>"
                                   class="w-full rounded-xl border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                        </div>

                        <div>
                            <label for="due_date" class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Due Date</label>
                            <input type="date" name="due_date" id="due_date" required value="<?php echo e(date('Y-m-d', strtotime('+30 days'))); ?>"
                                   class="w-full rounded-xl border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                        </div>
                    </div>
                    ...
                    <div class="pt-8 flex items-center justify-end space-x-4">
                        <a href="<?php echo e(route('app.invoices.index')); ?>" class="text-sm font-bold text-gray-500 hover:text-gray-700 transition-colors">
                            Discard
                        </a>
...
<?php endif; ?><?php /**PATH /var/www/html/ReNewPilot_new/resources/views/app/invoices/create.blade.php ENDPATH**/ ?>
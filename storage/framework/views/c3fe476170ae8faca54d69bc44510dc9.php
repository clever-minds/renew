...
<head>
    ...
    <title>Forgot Password - RenewPilot</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div class="max-w-md w-full z-10">
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500 mt-2 font-medium">Password Recovery</p>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-indigo-100 p-10 border border-white">
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 font-medium mt-1 leading-relaxed">No problem. Just let us know your email address and we will email you a password reset link.</p>
                </div>
                ...
                <form method="POST" action="<?php echo e(route('password.email')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus
                               class="w-full px-5 py-4 rounded-2xl bg-white border border-gray-200 text-gray-900 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-50 transition-all outline-none font-medium text-sm placeholder-gray-400" placeholder="your@email.com">
                    </div>
                ...
                <div class="mt-10 text-center">
                    <p class="text-sm text-gray-500 font-medium">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="text-indigo-600 font-black hover:text-indigo-700 ml-1">Back to Login</a>
                    </p>
                </div>
            </div>
...
<?php /**PATH /var/www/html/ReNewPilot_new/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>
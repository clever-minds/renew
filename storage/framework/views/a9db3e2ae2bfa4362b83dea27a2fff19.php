    ...
    <div class="space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                ...
                <a href="<?php echo e(route('app.reports.revenue', ['start_date' => $startDate, 'end_date' => $endDate, 'export' => 'csv'])); ?>" class="text-xs font-semibold text-indigo-600 hover:text-indigo-700">Export CSV</a>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: <?php echo json_encode($revenueByMethod->keys()->map(function($key) { return ucwords(str_replace('_', ' ', $key)); })); ?>,
                    datasets: [{

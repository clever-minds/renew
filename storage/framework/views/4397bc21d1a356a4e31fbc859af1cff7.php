                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e(ucfirst($service->billing_cycle)); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'create-service','title' => 'Add New Service']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'create-service','title' => 'Add New Service']); ?>
        <form method="POST" action="<?php echo e(route('app.services.store')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ReNewPilot_new\ReNewPilot\resources\views/app/services/index.blade.php ENDPATH**/ ?>
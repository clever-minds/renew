        ...
        <form method="POST" action="<?php echo e(route('app.subscriptions.update', $subscription)); ?>" class="space-y-6">
            ...
            <div class="flex justify-between items-center pt-6 border-t border-gray-50">
                ...
                <div class="flex space-x-3">
                    <button type="button" @click="$dispatch('close-modal', 'edit-subscription-<?php echo e($subscription->id); ?>')" class="text-sm font-bold text-gray-400 hover:text-gray-600">
                        Cancel
                    </button>
...
<?php endif; ?><?php /**PATH /var/www/html/ReNewPilot_new/resources/views/app/subscriptions/show.blade.php ENDPATH**/ ?>
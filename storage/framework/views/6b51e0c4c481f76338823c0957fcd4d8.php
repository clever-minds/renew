                ...
                <header class="bg-white border-b border-gray-200 flex items-center justify-between h-16 px-4 lg:px-8 print:hidden">
                    ...
                    <div class="flex items-center space-x-4 relative" x-data="{ userMenuOpen: false }">
                        <div class="hidden sm:block text-right">
                            ...
                            <p class="text-[10px] uppercase tracking-wider text-gray-500 font-bold"><?php echo e(auth()->user()->is_super_admin ? 'Super Admin' : 'Agency Owner'); ?></p>
                        </div>
                        ...
                        <div x-show="userMenuOpen" 
                            ...
                            <div class="px-4 py-2 border-b border-gray-50 sm:hidden">
                                ...
                                <p class="text-[10px] text-gray-500 truncate"><?php echo e(auth()->user()->email); ?></p>
                            </div>

                            <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-indigo-600 transition-colors font-medium">
                                <i class="fas fa-user w-5 text-gray-400 text-center mr-1"></i> View Profile
                            </a>
                            <form method="POST" action="<?php echo e(route('logout')); ?>" class="block w-full m-0">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/ReNewPilot_new/resources/views/layouts/app.blade.php ENDPATH**/ ?>
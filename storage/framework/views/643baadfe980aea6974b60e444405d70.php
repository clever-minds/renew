                                ...
                                <div class="p-5 bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-indigo-200 transition-all group">
                                    <div class="flex items-start justify-between">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <p class="text-sm font-black text-gray-900"><?php echo e($subscription->service->name); ?></p>
        ...
        <form method="POST" action="<?php echo e(route('app.clients.update', $client)); ?>" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="phone" value="<?php echo e($client->phone); ?>" class="w-full rounded-xl border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                </div>
                <div>
                    <label class="block text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2">Company</label>
                    <input type="text" name="company" value="<?php echo e($client->company); ?>" class="w-full rounded-xl border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                </div>
            </div>

        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col">
                    ...
                    <div class="text-4xl font-extrabold mb-6">$<?php echo e(number_format($plan->price, 2)); ?><span class="text-lg text-gray-400 font-normal">/<?php echo e($plan->billing_cycle); ?></span></div>
...
<?php /**PATH C:\laragon\www\ReNewPilot_new\ReNewPilot\resources\views/welcome.blade.php ENDPATH**/ ?>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="company_tagline" value="<?php echo e($company['company_tagline'] ?? ''); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="tax_number" value="<?php echo e($company['tax_number'] ?? ''); ?>"
                ...
                <div>
                    ...
                    <div class="flex items-center gap-6">
                        <div class="w-24 h-24 rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50 flex items-center justify-center overflow-hidden" id="qr-preview-wrap">
                            <?php if(!empty($company['qr_code_url'])): ?>
                                <img id="qr-preview" src="<?php echo e(asset('storage/' . $company['qr_code_url'])); ?>" class="w-full h-full object-contain p-1">
                            <?php else: ?>

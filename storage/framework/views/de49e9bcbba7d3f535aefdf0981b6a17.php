                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 cursor-pointer" onclick="window.location='<?php echo e(route('app.clients.show', $client)); ?>'">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <button @click.stop="$dispatch('open-drawer', 'edit-client-<?php echo e($client->id); ?>')" class="text-indigo-600 hover:text-indigo-900">Quick Edit</button>
                                    </td>
                                </tr>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ReNewPilot_new\ReNewPilot\resources\views/app/clients/index.blade.php ENDPATH**/ ?>
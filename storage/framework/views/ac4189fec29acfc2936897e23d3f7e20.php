    ...
    <div class="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div class="max-w-md w-full z-10">
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500 mt-2 font-medium">Elevate your agency management</p>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-indigo-100 p-10 border border-white">
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 font-medium mt-1">Please enter your credentials to continue</p>
                </div>

                <!-- Session Status -->
                <?php if(session('status')): ?>
                    <div class="mb-6 p-4 bg-emerald-50 rounded-2xl text-xs font-bold text-emerald-600 border border-emerald-100">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                    ...
                    <div>
                        <div class="flex justify-between mb-2 ml-1">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" class="text-[10px] font-black text-indigo-600 uppercase tracking-widest hover:text-indigo-700">Forgot?</a>
                        </div>
                    ...
                    <div class="flex items-center ml-1">
                        <input id="remember_me" type="checkbox" name="remember" class="w-4 h-4 rounded-lg border-gray-200 text-indigo-600 focus:ring-indigo-500">
                        <label for="remember_me" class="ml-3 block text-sm text-gray-500 font-medium">Keep me logged in</label>
                    </div>
                ...
                <div class="mt-10 text-center">
                    <p class="text-sm text-gray-500 font-medium">
                        New to RenewPilot? 
                        <a href="<?php echo e(route('register')); ?>" class="text-indigo-600 font-black hover:text-indigo-700 ml-1">Create Account</a>
                    </p>
                </div>
            </div>
...
<?php /**PATH /var/www/html/ReNewPilot_new/resources/views/auth/login.blade.php ENDPATH**/ ?>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($sub->client->name); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900"><?php echo e($sub->service->name); ?></div>
                                        <div class="text-sm text-gray-500">$<?php echo e(number_format($sub->price, 2)); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo e($sub->next_due_date->format('M d, Y')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                            <?php if($sub->status === 'active'): ?> bg-green-100 text-green-800 
                                            <?php elseif($sub->status === 'overdue'): ?> bg-red-100 text-red-800
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'create-subscription','title' => 'Create New Subscription']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'create-subscription','title' => 'Create New Subscription']); ?>
        <form method="POST" action="<?php echo e(route('app.subscriptions.store')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
            ...
            <div>
                ...
                <input type="date" name="starts_at" value="<?php echo e(date('Y-m-d')); ?>" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ReNewPilot_new\ReNewPilot\resources\views/app/subscriptions/index.blade.php ENDPATH**/ ?>
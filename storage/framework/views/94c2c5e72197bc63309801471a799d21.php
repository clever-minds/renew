...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('app.invoices.index')); ?>" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded shadow">
                Back to Invoices
            </a>
        </div>
     <?php $__env->endSlot(); ?>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="<?php echo e(route('app.invoices.store')); ?>" class="space-y-6" id="invoice-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="<?php echo e(route('app.invoices.index')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
                                Cancel
                            </a>
...
<?php endif; ?><?php /**PATH /var/www/renew.usamasheth.in/resources/views/app/invoices/create.blade.php ENDPATH**/ ?>
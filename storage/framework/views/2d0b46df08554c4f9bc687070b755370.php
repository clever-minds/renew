...
<head>
    ...
    <title>Reset Password - RenewPilot</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div class="max-w-md w-full z-10">
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500 mt-2 font-medium">Create New Password</p>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-indigo-100 p-10 border border-white">
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 font-medium mt-1">Choose a strong password to secure your account</p>
                </div>
                ...
                <form method="POST" action="<?php echo e(route('password.store')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email', $request->email)); ?>" required autofocus readonly
                               class="w-full px-5 py-4 rounded-2xl bg-gray-50 border border-gray-200 text-gray-500 outline-none font-medium text-sm">
                    </div>

                    <div>
                        <label class="block text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-2 ml-1">New Password</label>
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-2 ml-1">Confirm Password</label>
...
<?php /**PATH /var/www/html/ReNewPilot_new/resources/views/auth/reset-password.blade.php ENDPATH**/ ?>
<x-app-layout>
    ...
    <div class="max-w-4xl space-y-8">
        ...
        <section class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('app.settings.company') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="terms_conditions" rows="4"
                              ...
                              placeholder="e.g. Payment is due within 14 days of invoice date. Late payments may attract a 2% monthly interest charge...">{{ $company['terms_conditions'] ?? '' }}</textarea>
                </div>

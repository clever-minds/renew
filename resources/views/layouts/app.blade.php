            ...
            <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
                ...
                <div class="flex flex-col h-full">
                    ...
                    <div class="flex items-center justify-between h-16 px-6 bg-indigo-800">
                        <a href="{{ route('app.dashboard') }}" class="flex items-center space-x-3">
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto sidebar-scroll">
                        @if(auth()->check() && auth()->user()->is_super_admin)
                            <div class="px-3 mb-4">
                                ...
                                <a href="{{ route('admin.dashboard') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group {{ request()->routeIs('admin.dashboard') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                                    <i class="fas fa-chart-line w-6 text-indigo-300 group-hover:text-white transition-colors"></i>
                                    SaaS Dashboard
                                </a>
                                <a href="{{ route('admin.tenants') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group mt-1 {{ request()->routeIs('admin.tenants*') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                        ...
                        @else
                            ...
                            <a href="{{ route('app.dashboard') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group {{ request()->routeIs('app.dashboard') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                                <i class="fas fa-th-large w-6 text-indigo-300 group-hover:text-white transition-colors"></i>
                                Dashboard
                            </a>
                            <a href="{{ route('app.clients.index') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group mt-1 {{ request()->routeIs('app.clients*') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                                <i class="fas fa-users w-6 text-indigo-300 group-hover:text-white transition-colors"></i>
                                Clients
                            </a>
                            <a href="{{ route('app.services.index') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group mt-1 {{ request()->routeIs('app.services*') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                                <i class="fas fa-concierge-bell w-6 text-indigo-300 group-hover:text-white transition-colors"></i>
                                Services
                            </a>
                            <a href="{{ route('app.subscriptions.index') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group mt-1 {{ request()->routeIs('app.subscriptions*') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                                <i class="fas fa-calendar-alt w-6 text-indigo-300 group-hover:text-white transition-colors"></i>
                                Subscriptions
                            </a>
                            <a href="{{ route('app.invoices.index') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group mt-1 {{ request()->routeIs('app.invoices*') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                                <i class="fas fa-file-invoice-dollar w-6 text-indigo-300 group-hover:text-white transition-colors"></i>
                                Invoices
                            </a>
                            <a href="{{ route('app.payments.index') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group mt-1 {{ request()->routeIs('app.payments*') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                            ...
                            <div class="pt-8">
                                ...
                                <a href="{{ route('app.reports.revenue') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group {{ request()->routeIs('app.reports.revenue') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                                    <i class="fas fa-chart-pie w-6 text-indigo-300 group-hover:text-white transition-colors"></i>
                                    Revenue Report
                                </a>
                                <a href="{{ route('app.reports.subscriptions') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group mt-1 {{ request()->routeIs('app.reports.subscriptions') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                            ...
                            <div class="pt-8">
                                ...
                                <a href="{{ route('app.settings.index') }}" class="flex items-center px-3 py-2.5 text-sm font-bold rounded-xl text-indigo-100 hover:bg-white/10 hover:text-white transition-all group {{ request()->routeIs('app.settings*') ? 'bg-white/15 text-white shadow-sm' : '' }}">
                        ...
                        @if (session('error') || session('warning'))
                            <div class="bg-white border-l-4 border-red-500 shadow-xl rounded-lg p-4 mb-4 flex items-start space-x-3 transition-all transform">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-gray-600 mt-1">{{ session('error') ?? session('warning') }}</p>
                                </div>
                                <button @click="show = false" class="text-gray-400 hover:text-gray-600">
                                    <i class="fas fa-times"></i>
                                </button>
